...
def main():
    ...
    subparsers = parser.add_subparsers(
        help="Specify the operation mode.", required=True
    )
    ...
    parser_client.add_argument(
        "-p", dest="port", type=int, help="Server port to connect to.", default=2154
    )
    ...
    parser_server.add_argument(
        dest="client_ip", type=str, help="IP Address to ping regularly"
    )
    ...
    parser_server.add_argument(
        ...
        default="/opt/DUT_Tester/logs_client/",
    )
...
def start_server(args):
    from DUT_Tester.Server import Server
